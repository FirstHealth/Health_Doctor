...
public class SickAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<SickBean.ResultBean> list;

    public SickAdapter(Context context, List<SickBean.ResultBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == 0){
            ...
            ((ViewHolderOne)holder).ll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    SickBean.ResultBean resultBean = list.get(position);
            ...
            ((ViewHolderTwo)holder).ll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    SickBean.ResultBean resultBean = list.get(position);
                    EventBus.getDefault().post(resultBean);
